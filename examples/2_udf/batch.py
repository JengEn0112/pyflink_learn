...
import os
import shutil
from pyflink.table import EnvironmentSettings, DataTypes, TableEnvironment
...
# 运行下述命令，成包含有安装包的 cached_dir 文件夹S
...
# t_env.execute_sql("""
#     INSERT INTO sink
#     SELECT get_topic(line) AS topic,
#        get_fake_country() AS fake_country,
#        get_ip_src(get_topic(line), line) AS ip_src,
#        get_ip_host(line) AS ip_host,
#        get_user_name(topic, line) AS user_name,
#        get_user_group(line) AS user_group,
#        get_msg_content(topic, line) AS msg_content,
